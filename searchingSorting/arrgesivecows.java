...
public class arrgesivecows {
    BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
    PrintWriter out = new PrintWriter(new BufferedOutputStream(System.out));

    public static void main(String[] args) throws IOException {
        new arrgesivecows().run();
    }
    ...
    /**
     * Conduct a binary search to find the largest distance d such that the minimum
     * distance of d is achieveable, while the minimum distance of d is not.
     * 
